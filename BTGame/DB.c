...
int DBInsertImage(DB *self, StringView id, const char *path) {
   ...
   //sqlite3_bind_text(db->ImageStmts.insert, 1, id, -1, NULL);
   //sqlite3_bind_blob(db->ImageStmts.insert, 2, buff, size, SQLITE_TRANSIENT);
   //sqlite3_bind_int(db->ImageStmts.insert, 3, 1);
   //sqlite3_bind_double(db->ImageStmts.insert, 4, 5.0);
   //sqlite3_bind_
